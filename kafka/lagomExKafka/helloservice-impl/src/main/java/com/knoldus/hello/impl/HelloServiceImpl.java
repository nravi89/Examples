...
public class HelloServiceImpl implements HelloService {
    ...
    public Topic<GreetingMessage> greetingsTopic() {
    	System.out.println("greetingsTopic #####################################33");
    	...
    	/*return TopicProducer.singleStreamWithOffset(offset -> Source.from(Collections.singletonList(new Pair<>("Rishi",offset)))
                .map(this::convertEvent));*/
    }
   ...
   /* private Pair<String, Offset> convertEvent(Pair<String, Offset> pair) {
        return new Pair<>(new String(pair.first()), pair.second());
    }*/
}
