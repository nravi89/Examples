...
public class ListDirDemo extends P4JavaDemo {
	...
	public static void main(String[] args) {
		try {		
			...
			List<IFileSpec> fileList = server.getDirectories(
					FileSpecBuilder.makeFileSpecList("//qa/ReportingDashboard/*"), new GetDirectoriesOptions());
			if (fileList != null) {
				for (IFileSpec fileSpec : fileList) {
					if (fileSpec != null) {
						if (fileSpec.getOpStatus() == FileSpecOpStatus.VALID) {
							System.out.println("========================");
							System.out.println(fileSpec.getAnnotatedPreferredPathString());
						} else {
							System.out.println("+++++++++++++++++++++++++");
